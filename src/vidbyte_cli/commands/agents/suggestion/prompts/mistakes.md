...
Mistakes and Lessons is the named prior failure lesson value that this command accepts for one suggestion workflow.
It gives the parent agent a stable way to state an earlier mistake together with its cause and the lesson that should survive it.
...
**Purpose of Mistakes and Lessons**
The purpose of Mistakes and Lessons is to make an earlier mistake together with its cause and the lesson that should survive it explicit before candidate generation starts.
...
**When not to use Mistakes and Lessons**
Do not provide Mistakes and Lessons merely because the option exists or because an empty value would look complete.
...
**Defaults and precedence for Mistakes and Lessons**
When it is omitted, the default is no supplied prior failure lesson..
...
**Mistakes and Lessons output contract**
Mistakes and Lessons is not printed as a separate progress message because stdout is reserved for the command result.
...
**How to use Mistakes and Lessons**
...
```text
vidbyte-cli agents suggest run --goal "{goal}" --mistakes "{failure, cause, lesson}"
```

**Examples for Mistakes and Lessons**
...
```text
vidbyte-cli agents suggest run --goal "{goal}" --mistakes "{failure, cause, lesson}"
vidbyte-cli --json agents suggest run --goal "{goal}" --mistakes "{value}"
```

**Related commands for Mistakes and Lessons**
...
**Failure modes for Mistakes and Lessons**
...
**Authentication and permissions for Mistakes and Lessons**
