...
class TaskBoardSettings(BaseModel):
    ...
    allow_decompose: bool = Field(
        ...
        description=(
            ...
            "and 3. Children never decompose further in v1, and the window, handoff, and "
            "summary settings are ignored while this mode is on. Because a splice shifts board "
            "indices, it runs only on unchecked linear boards."
        ),
    )
