...
Treat that context, together with the per-candidate critiques and rubric scores carried in context, as useful evidence from another agent rather than a verdict or field-level repair order.
