...
2. Read the complete eleven-section rubric assessment in the matching critique and find the sections that scored lowest. Those sections are the diagnosis behind the verdict, and they name the part of the candidate that actually failed. Where the explanation says the supplied context could not answer a section, treat that as missing information rather than as a defect to write around. Let the lowest-scoring sections decide where you edit.
