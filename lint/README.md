...
| C005 | suggestion-help-section-depth | Every suggestion context-help asset has bold Title, Description, Why it matters, and Influence on output sections with 6-8 sentences each. |
